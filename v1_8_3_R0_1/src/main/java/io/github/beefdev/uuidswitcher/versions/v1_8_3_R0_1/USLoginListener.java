            ...
            if (this.server.aJ() >= 0 && !this.networkManager.c()) {
                this.networkManager.a(new PacketLoginOutSetCompression(this.server.aJ()), new ChannelFutureListener() {
                    public void a(ChannelFuture channelfuture) throws Exception {
                        USLoginListener.this.networkManager.a(USLoginListener.this.server.aJ());
                    }
        ...
        if (!Arrays.equals(this.e, packetlogininencryptionbegin.b(privatekey))) {
            ...
            (new Thread("User Authenticator #" + b.incrementAndGet()) {
                public void run() {
                    ...
                    try {
                        String s = (new BigInteger(MinecraftEncryption.a(USLoginListener.this.j, USLoginListener.this.server.P().getPublic(), USLoginListener.this.loginKey))).toString(16);
                        USLoginListener.this.i = USLoginListener.this.server.aC().hasJoinedServer(new GameProfile((UUID)null, gameprofile.getName()), s);
                        if (USLoginListener.this.i != null) {
                            ...
                            (USLoginListener.this.new LoginHandler()).fireEvents();
                        } else if (USLoginListener.this.server.S()) {
                        ...
                        if (USLoginListener.this.server.S()) {
