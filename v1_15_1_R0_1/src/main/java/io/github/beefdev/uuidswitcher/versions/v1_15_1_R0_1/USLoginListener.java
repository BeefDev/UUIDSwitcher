package io.github.beefdev.uuidswitcher.versions.v1_15_1_R0_1;
        ...
        if (!Arrays.equals(this.e, packetlogininencryptionbegin.b(privatekey))) {
            ...
            Thread thread = new Thread("User Authenticator #" + b.incrementAndGet()) {
                ...
                private InetAddress a() {
                    ...
                    return USLoginListener.this.server.X() && socketaddress instanceof InetSocketAddress ? ((InetSocketAddress)socketaddress).getAddress() : null;
                }
            };
