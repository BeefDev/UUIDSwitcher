...
public final class USLoginListener extends LoginListener implements PacketLoginInListener {
    ...
    public void c() {
        ...
        if (s != null) {
            ...
            if (this.g.av() >= 0 && !this.a.isLocal()) {
                this.a.sendPacket(new PacketLoginOutSetCompression(this.g.av()), (channelfuture) -> {
                    this.a.setCompressionLevel(this.g.av(), true);
                });
            }
    ...
    public void a(PacketLoginInEncryptionBegin packetlogininencryptionbegin) {
        ...
        Thread thread = new Thread("User Authenticator #" + b.incrementAndGet()) {
            ...
            private @Nullable InetAddress a() {
                ...
                return USLoginListener.this.g.W() && socketaddress instanceof InetSocketAddress ? ((InetSocketAddress)socketaddress).getAddress() : null;
            }
        };
    ...
    public class LoginHandler {
        ...
        public void fireEvents() throws Exception {
            ...
            USLoginListener.this.j = new GameProfile(uniqueId, playerName);
