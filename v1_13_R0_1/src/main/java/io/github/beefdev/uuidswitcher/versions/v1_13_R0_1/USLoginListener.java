package io.github.beefdev.uuidswitcher.versions.v1_13_R0_1;
...
import org.bukkit.craftbukkit.v1_13_R1.util.Waitable;
        ...
        if (!Arrays.equals(this.e, packetlogininencryptionbegin.b(privatekey))) {
            ...
            Thread thread = new Thread("User Authenticator #" + b.incrementAndGet()) {
                public void run() {
                    ...
                    try {
                        String s = (new BigInteger(MinecraftEncryption.a("", USLoginListener.this.server.G().getPublic(), USLoginListener.this.loginKey))).toString(16);
                        USLoginListener.this.i = USLoginListener.this.server.ar().hasJoinedServer(new GameProfile((UUID)null, gameprofile.getName()), s, this.a());
                        if (USLoginListener.this.i != null) {
                            ...
                            (USLoginListener.this.new LoginHandler()).fireEvents();
                        } else if (USLoginListener.this.server.J()) {
                        ...
                        if (USLoginListener.this.server.J()) {
