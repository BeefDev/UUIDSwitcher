        ...
        switch (packethandshakinginsetprotocol.a().ordinal()+1) {
            ...
            case 4:
                ...
                if (packethandshakinginsetprotocol.b() > 315) {
                    chatcomponenttext = new ChatComponentText(MessageFormat.format(SpigotConfig.outdatedServerMessage.replaceAll("'", "''"), "1.11"));
                    this.b.sendPacket(new PacketLoginOutDisconnect(chatcomponenttext));
                    this.b.close(chatcomponenttext);
                } else if (packethandshakinginsetprotocol.b() < 315) {
                    chatcomponenttext = new ChatComponentText(MessageFormat.format(SpigotConfig.outdatedClientMessage.replaceAll("'", "''"), "1.11"));
                    this.b.sendPacket(new PacketLoginOutDisconnect(chatcomponenttext));
                    this.b.close(chatcomponenttext);
                } else {
