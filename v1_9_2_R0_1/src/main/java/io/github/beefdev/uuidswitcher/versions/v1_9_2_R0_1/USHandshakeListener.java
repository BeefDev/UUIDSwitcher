package io.github.beefdev.uuidswitcher.versions.v1_9_2_R0_1;
        ...
        switch (packethandshakinginsetprotocol.a()) {
            case LOGIN:
                ...
                if (packethandshakinginsetprotocol.b() > 109) {
                    chatcomponenttext = new ChatComponentText(MessageFormat.format(SpigotConfig.outdatedServerMessage.replaceAll("'", "''"), "1.9.2"));
                    this.b.sendPacket(new PacketLoginOutDisconnect(chatcomponenttext));
                    this.b.close(chatcomponenttext);
                } else if (packethandshakinginsetprotocol.b() < 107) {
                    chatcomponenttext = new ChatComponentText(MessageFormat.format(SpigotConfig.outdatedClientMessage.replaceAll("'", "''"), "1.9.2"));
                    this.b.sendPacket(new PacketLoginOutDisconnect(chatcomponenttext));
                    this.b.close(chatcomponenttext);
                } else {
