package io.github.beefdev.uuidswitcher.versions.v1_13_2_R0_1;
        ...
        if (!Arrays.equals(this.e, packetlogininencryptionbegin.b(privatekey))) {
            ...
            Thread thread = new Thread("User Authenticator #" + b.incrementAndGet()) {
                public void run() {
                    ...
                    try {
                        String s = (new BigInteger(MinecraftEncryption.a("", USLoginListener.this.server.E().getPublic(), USLoginListener.this.loginKey))).toString(16);
                        USLoginListener.this.i = USLoginListener.this.server.ap().hasJoinedServer(new GameProfile((UUID)null, gameprofile.getName()), s, this.a());
                        if (USLoginListener.this.i != null) {
                            ...
                            (USLoginListener.this.new LoginHandler()).fireEvents();
                        } else if (USLoginListener.this.server.H()) {
                        ...
                        if (USLoginListener.this.server.H()) {
                ...
                private InetAddress a() {
                    ...
                    return USLoginListener.this.server.S() && socketaddress instanceof InetSocketAddress ? ((InetSocketAddress)socketaddress).getAddress() : null;
                }
            };
