package io.github.beefdev.uuidswitcher.versions.v1_16_3_R0_1;
        ...
        if (!Arrays.equals(this.e, packetlogininencryptionbegin.b(privatekey))) {
            ...
            Thread thread = new Thread("User Authenticator #" + b.incrementAndGet()) {
                ...
                private @Nullable InetAddress a() {
                    ...
                    return USLoginListener.this.server.V() && socketaddress instanceof InetSocketAddress ? ((InetSocketAddress)socketaddress).getAddress() : null;
                }
            };
