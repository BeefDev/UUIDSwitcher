package io.github.beefdev.uuidswitcher.versions.v1_11_2_R0_1;
...
public final class USLoginListener extends LoginListener implements PacketLoginInListener, ITickable {
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (USLoginListener.this.i != null) {
                            ...
                            USLoginListener.this.disconnect("Failed to verify username!");
                            USLoginListener.c.error("Username '{}' tried to join with an invalid session", new Object[]{gameprofile.getName()});
                        }
    ...
    public class LoginHandler {
        ...
        public void fireEvents() throws Exception {
            ...
            USLoginListener.c.info("UUID of player {} is {}", new Object[]{USLoginListener.this.i.getName(), USLoginListener.this.i.getId()});
            USLoginListener.this.g = USLoginListener.EnumProtocolState.READY_TO_ACCEPT;
        }
    }
}
