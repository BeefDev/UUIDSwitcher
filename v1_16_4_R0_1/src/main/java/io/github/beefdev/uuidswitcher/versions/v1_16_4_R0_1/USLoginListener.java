package io.github.beefdev.uuidswitcher.versions.v1_16_4_R0_1;
    ...
    public void a(PacketLoginInEncryptionBegin packetlogininencryptionbegin) {
        ...
        Thread thread = new Thread("User Authenticator #" + b.incrementAndGet()) {
            ...
            private @Nullable InetAddress a() {
                ...
                return USLoginListener.this.server.W() && socketaddress instanceof InetSocketAddress ? ((InetSocketAddress)socketaddress).getAddress() : null;
            }
        };
