...
public final class USLoginListener extends LoginListener implements PacketLoginInListener, IUpdatePlayerListBox {
    ...
    public void c() {
        if (this.g == USLoginListener.EnumProtocolState.READY_TO_ACCEPT) {
            this.b();
        } else if (this.g == USLoginListener.EnumProtocolState.e) {
    ...
    public void b() {
        ...
        if (s != null) {
            ...
            if (this.server.aK() >= 0 && !this.networkManager.c()) {
                this.networkManager.a(new PacketLoginOutSetCompression(this.server.aK()), new ChannelFutureListener() {
                    public void a(ChannelFuture channelfuture) throws Exception {
                        USLoginListener.this.networkManager.a(USLoginListener.this.server.aK());
                    }
            ...
            EntityPlayer entityplayer = this.server.getPlayerList().a(this.i.getId());
            if (entityplayer != null) {
                this.g = USLoginListener.EnumProtocolState.e;
        ...
        if (!Arrays.equals(this.e, packetlogininencryptionbegin.b(privatekey))) {
            ...
            (new Thread("User Authenticator #" + b.incrementAndGet()) {
                public void run() {
                    ...
                    try {
                        String s = (new BigInteger(MinecraftEncryption.a(USLoginListener.this.j, USLoginListener.this.server.Q().getPublic(), USLoginListener.this.loginKey))).toString(16);
                        USLoginListener.this.i = USLoginListener.this.server.aD().hasJoinedServer(new GameProfile((UUID)null, gameprofile.getName()), s);
                        if (USLoginListener.this.i != null) {
                            if (!USLoginListener.this.networkManager.g()) {
                                return;
                            }

                            (USLoginListener.this.new LoginHandler()).fireEvents();
                        } else if (USLoginListener.this.server.T()) {
                        ...
                        if (USLoginListener.this.server.T()) {
