package io.github.beefdev.uuidswitcher.versions.v1_14_3_R0_1;
        ...
        switch (packethandshakinginsetprotocol.b().ordinal()+1) {
            ...
            case 4:
                ...
                if (packethandshakinginsetprotocol.c() > SharedConstants.a().getProtocolVersion()) {
                    chatmessage = new ChatMessage(MessageFormat.format(SpigotConfig.outdatedServerMessage.replaceAll("'", "''"), SharedConstants.a().getName()), new Object[0]);
                    this.b.sendPacket(new PacketLoginOutDisconnect(chatmessage));
                    this.b.close(chatmessage);
                } else if (packethandshakinginsetprotocol.c() < SharedConstants.a().getProtocolVersion()) {
                    chatmessage = new ChatMessage(MessageFormat.format(SpigotConfig.outdatedClientMessage.replaceAll("'", "''"), SharedConstants.a().getName()), new Object[0]);
                    this.b.sendPacket(new PacketLoginOutDisconnect(chatmessage));
                    this.b.close(chatmessage);
                } else {
